...
class uzivatel_tem extends template {
    ...
    public function pisPolozku($param) {
        ...
        echo '              <input type="text" name="uzi_jmeno" value="' . $param["data"][0]["uzi"]->jmeno . '" />';
        echo '              <div class="nav">Přihlašovací jméno</div>';
        echo '              <input type="text" name="uzi_login" value="' . $param["data"][0]["uzi"]->login . '" />';
        echo '              <div class="nav">Heslo</div>';
        echo '              <input type="password" name="uzi_heslo" value="" />';
        echo '              <div class="nav">Email</div>';
        echo '              <input type="text" name="uzi_email" value="' . $param["data"][0]["uzi"]->email . '" />';
        echo '              <input type="hidden" name="uzi_id" value="' . $param["data"][0]["uzi"]->id . '" />';
